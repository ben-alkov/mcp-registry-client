...
Configuration is possible via [config.toml.example](config.toml.example)
(edit and rename to config.toml).
...
This is TL;DR, see [CONTRIBUTING](docs/CONTRIBUTING.md)
...
See [config.toml.example](config.toml.example). You can use environment
variables if you choose to.
...
This project is licensed under the GPL-3.0-or-later License - see
